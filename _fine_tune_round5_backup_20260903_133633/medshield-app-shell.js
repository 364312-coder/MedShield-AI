(function(){
  ...
  function buildOverview(view){
    ...
    stage.innerHTML=`
      <div class="app-overview-flow" aria-label="MedShield-AI 核心闭环">
        ...
        <div class="app-overview-node"><span>风险研判</span><strong>AutoEncoder + LightGBM</strong></div><div class="app-overview-arrow">→</div>
        ...
        <div class="app-overview-node"><span>可信验证</span><strong>Joint Integrity + Conditional Recovery</strong></div><div class="app-overview-arrow">→</div>
  ...
  function moveEvidence(view){
    ...
    if(metricsLayout){
      ...
      summary.innerHTML=`
        <div class="app-core-conclusion"><span>FORMAL FULL RUN</span><strong>98.44%</strong><b>总体 Accuracy</b><p>在 50,000 条正式事件中完成检测、处置与完整性链路验证，并对确认异常事件执行恢复验证。</p></div>
