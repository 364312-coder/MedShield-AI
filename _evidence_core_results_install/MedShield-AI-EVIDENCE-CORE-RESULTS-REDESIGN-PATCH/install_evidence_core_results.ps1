...
if (-not (Test-Path -LiteralPath (Join-Path $public "medshield-app-shell.css"))) {
  throw "Target medshield-app-shell.css not found: $public"
}
if (-not (Test-Path -LiteralPath (Join-Path $public "medshield-app-shell.js"))) {
  throw "Target medshield-app-shell.js not found: $public"
}

$stamp = Get-Date -Format "yyyyMMdd_HHmmss"
$backup = Join-Path $Target "_evidence_core_results_backup_$stamp"
...
Write-Host "EVIDENCE CORE RESULTS REDESIGN INSTALLED" -ForegroundColor Green
Write-Host "Modified only: medshield-app-shell.css / medshield-app-shell.js"
